...
public class YourDeal_Page extends BasePage {
    ...
    private List<WebElement> bookWithFullProtectionButtons;//1st is on the right 2nd is at the bottom
    @FindBy(css = ".me-4 div.check-option")
    private List<WebElement> noInsuranceOrFullProtectionRadioButtons;//1st no insurance 2nd full protection
    @FindBy(css = ".fs-3.mt-4")
    private List<WebElement> noInsuranceOrFullProtectionPrices;//1st no insurance 2nd full protection

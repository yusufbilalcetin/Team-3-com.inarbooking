...
public class FlightVerification_stepDefs extends BaseStep {
    ...
    public void the_user_selected_depature_as_a(String string) {
        ...
        Assertions.assertThat(PAGES.getFlightsFilterAndListPage().getDepartureCountrySelectText()).isEqualTo(string);
    ...
    public void the_user_selected_arrival_country_as_a(String string) {
        ...
        Assertions.assertThat(PAGES.getFlightsFilterAndListPage().getArrivalCountrySelectText()).isEqualTo(string);
    ...
    public void the_user_should_see_message(String string) {
        Assertions.assertThat(PAGES.getFlightTabVerification().getfindYourNextFlightMessage())
    ...
    public void the_user_should_see_that_just_list_of_and_are_displayed(String string, String string2) {
        Assertions.assertThat(PAGES.getFlightTabVerification().getOriginCountry()).isEqualTo(string);
        Assertions.assertThat(PAGES.getFlightTabVerification().getDestinationCountry()).isEqualTo(string2);
    }
